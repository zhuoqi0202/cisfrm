...
@Documented
@Constraint(validatedBy = CpyCodeUniqueValidator.class)
public @interface CpyCodeUnique {
    String message() default "{com.sinosoft.cisfrm.server.validation.CpyCodeUnique.message}";
