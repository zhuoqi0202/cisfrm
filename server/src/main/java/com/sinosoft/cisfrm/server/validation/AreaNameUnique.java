...
@Documented
@Constraint(validatedBy = AreaNameUniqueValidator.class)
public @interface AreaNameUnique {
    String message() default "{com.sinosoft.cisfrm.server.validation.AreaNameUnique.message}";
